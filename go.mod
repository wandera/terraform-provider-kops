...
require (
	...
	github.com/miekg/coredns v1.2.1 // indirect
...
replace github.com/miekg/coredns => github.com/coredns/coredns v0.0.0-20161111164017-20e25559d5ea

replace github.com/digitalocean/godo => github.com/digitalocean/godo v1.1.1-0.20170706200301-34840385860d

replace github.com/docker/docker => github.com/docker/engine v0.7.3-0.20180612054059-a9fbbdc8dd87

replace github.com/docker/engine-api => github.com/docker/engine-api v0.3.2-0.20160509170047-dea108d3aa0c

replace k8s.io/kops/upup/models => ../models
